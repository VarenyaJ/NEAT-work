...
trinuc_trans_matrices = [copy.deepcopy(DEFAULT_SUBSTITUTION_MATRIX) for _ in range(16)]



DEFAULT_MUT_MODEL_OVERALL_MUT_RATE = 0.001
DEFAULT_MUT_MODEL_HOMOZYGOUS_FREQ = 0.02
DEFAULT_MUT_MODEL_INDEL_FRACTION = 0.01
DEFAULT_MUT_MODEL_INDEL_INS_PCT = 0.4
...
#model = MutationModel(avg_mut_rate=0.001,
 #                     homozygous_freq=0.010,
  #                    insertion_chance=0.004,
   #                   deletion_chance=0.006,
    #                  substitution_chance=0.99,
     #                 is_cancer=False,
      #                trinuc_trans_matrices=DEFAULT_MUT_MODEL_TRIUC_FREQS,
       #               trinuc_trans_bias=DEFAULT_MUT_MODEL_TRINUC_BIAS,
        #              insert_lengths=DEFAULT_MUT_MODEL_INS_LENGTH_VALUES,
         #             ins_len_weights=DEFAULT_MUT_MODEL_INS_LENGTH_WEIGHTS,
          #            deletion_lengths=DEFAULT_MUT_MODEL_DEL_LENGTH_VALUES,
           #           del_len_weights=DEFAULT_MUT_MODEL_DEL_LENGTH_WEIGHTS,)
